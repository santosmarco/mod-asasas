...
export const cryptoTokensRelations = relations(
  cryptoTokens,
  ({ one, many }) => ({
...
export const cryptoNetworksRelations = relations(
  cryptoNetworks,
  ({ many }) => ({
...
export const fiatCurrenciesRelations = relations(
  fiatCurrencies,
  ({ many }) => ({
...
export const currencyTradingPairsRelations = relations(
  currencyTradingPairs,
  ({ one }) => ({
    currency_receivingCurrency: one(currencies, {
      ...
      relationName:
        'currencyTradingPairs_receivingCurrency_currencies_currencyAbrev',
    }),
    currency_sendingCurrency: one(currencies, {
      fields: [currencyTradingPairs.sendingCurrency],
      references: [currencies.currencyAbrev],
      relationName:
        'currencyTradingPairs_sendingCurrency_currencies_currencyAbrev',
    }),
  })
)

...
2. `submitted`: Order confirmed with transaction hash
3. `raised`: Funds detected
4. `sent`: Transfer initiated
5. `received`: Transfer completed
...
<CardGroup cols={2}>
  ...
  <Card title="Order Monitoring" icon="chart-line" href="/guides/monitoring">
    Set up comprehensive order monitoring.
  </Card>
</CardGroup>

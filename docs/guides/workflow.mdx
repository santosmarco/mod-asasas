...
response = requests.post(
    'http://localhost:3000/api/recipients',
    headers=headers,
...
<Card horizontal title="Orders Guide" icon="file-invoice" href="/guides/orders">
  Explore our comprehensive Orders Guide for detailed information about creating
  and managing orders.
</Card>
...
response = requests.put(
    f'http://localhost:3000/api/orders/{order_id}/confirm',
    headers=headers,
    json=confirmation
)
...
>
  Discover comprehensive monitoring tools and best practices.
</Card>
...
order_id = 'ord_123'
response = requests.put(
    f'http://localhost:3000/api/orders/{order_id}/payment_identifiers',
    headers=headers
)
...
>
  Understand our comprehensive validation rules and best practices.
</Card>
...
<Card
  ...
  href="/guides/monitoring"
>
  Set up comprehensive monitoring for your integration.
</Card>
